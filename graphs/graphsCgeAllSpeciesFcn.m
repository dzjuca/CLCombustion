...
% --------------------------| Concentration vs time |----------------------
    ...
    hold on
        ...
        plot(tmin,CiE(:,n,3)','kp-','MarkerSize',MZ1);
        plot(tmin,CiE(:,n,4)','kd-','MarkerSize',MZ1);
        plot(tmin,CiE(:,n,5)','k*-','MarkerSize',MZ1);
...
% --------------------------| Concentration vs space |---------------------
    ...
    hold on
        ...
        plot(zg,CiE(m,:,3)','kp-','MarkerSize',MZ1);
        plot(zg,CiE(m,:,4)','kd-','MarkerSize',MZ1);
        plot(zg,CiE(m,:,5)','k*-','MarkerSize',MZ1);
