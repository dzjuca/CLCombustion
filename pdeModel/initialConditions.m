...
% ---------- u7w = NiO wake -----------------------------------------------
    for i = 1:n, u7w(i) = 0.15;    u(i+12*n) = u7w(i);     end
% ---------- u7w = Ni  wake -----------------------------------------------
    for i = 1:n, u8w(i) = 0.00;    u(i+13*n) = u8w(i);     end
% ---------- u7w = C wake -------------------------------------------------
    for i = 1:n, u9w(i) = 0.00;    u(i+14*n) = u9w(i);     end
% ---------- u7e = NiO emulsion -------------------------------------------
    for i = 1:n, u7e(i) = 0.15;    u(i+15*n) = u7e(i);     end
% ---------- u7e = Ni emulsion --------------------------------------------
    for i = 1:n, u8e(i) = 0.00;    u(i+16*n) = u8e(i);     end
% ---------- u7e = C emulsion ---------------------------------------------
